...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
        ...
        if (getChildCount() > 0) {
            ...
            if (mActiveCard != null) {
                ...
                flingCardListener = new FlingCardListener(mActiveCard, mAdapter.getItem(0),
                    ...
                    @Override
                    public boolean isLeftExitAvailable() {
                        return mFlingListener.isLeftCardExitAvailable();
                    }

                    @Override
                    public boolean isRightExitAvailable() {
                        return mFlingListener.isRightCardExitAvailable();
                    }
                });
    ...
    public interface onFlingListener {
        ...
        boolean isRightCardExitAvailable();
